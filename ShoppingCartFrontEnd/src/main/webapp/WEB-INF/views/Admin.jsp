	  ...
	  <div class="header_bottom">
	   <div class="logo">
	     ...
	     <ul class="megamenu skyblue">
	        ...
	        <div class="clearfix"> </div>
	     <a class="color10" href="manageCategories"><h4>Manage Categories</h4></a>&nbsp; &nbsp;
<a href="manageSuppliers"><h4>Manage Suppliers</h4></a>&nbsp; &nbsp;
<a href="manageProducts"><h4>Manage Products</h4></a>&nbsp; &nbsp;
